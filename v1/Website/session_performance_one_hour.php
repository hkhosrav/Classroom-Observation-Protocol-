  ...
  <body class="nav-md">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="validateForm" action="session_performance_one_hour.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Semester">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_2=$dbcon->prepare("SELECT Semester FROM Session_One_Hour GROUP BY Semester");
                            $stmt_2->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Teaching_Week">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_3=$dbcon->prepare("SELECT Teaching_Week FROM Session_One_Hour GROUP BY Teaching_Week");
                            $stmt_3->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Date">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_4=$dbcon->prepare("SELECT Date FROM Session_One_Hour GROUP BY Date");
                            $stmt_4->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Course_Code">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_5=$dbcon->prepare("SELECT Course_Code FROM Session_One_Hour GROUP BY Course_Code");
                            $stmt_5->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Instructor">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_6=$dbcon->prepare("SELECT Personal_No, First_Name, Last_Name FROM Instructor WHERE Personal_No IN (SELECT Instructor FROM Session_One_Hour GROUP BY Instructor)");
                            $stmt_6->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="Start_Time">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_7=$dbcon->prepare("SELECT Start_Time FROM Session_One_Hour GROUP BY Start_Time");
                            $stmt_7->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                          <select class="form-control" name="ID">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_8=$dbcon->prepare("SELECT ID FROM Session_One_Hour GROUP BY ID");
                            $stmt_8->execute();
              ...
              <?php
                if(isset($_POST['submit1'])){
                  ...
                  $stmt_op_1_1=$dbcon->prepare("SELECT COUNT(DISTINCT(Student_Activity)) FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_1->execute();
                  $json_op_1_1 = 0;
                  ...
                  $stmt_op_1_2=$dbcon->prepare("SELECT COUNT(DISTINCT(Faculty_Activity)) FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_2->execute();
                  $json_op_1_2 = 0;
                  ...
                  $stmt_op_1_3=$dbcon->prepare("SELECT AVG(Student_Engagement)*100 FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_3->execute();
                  $json_op_1_3 = 0;
                  ...
                  $stmt_op_1_4=$dbcon->prepare("SELECT AVG(Num_Students) FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_4->execute();
                  $json_op_1_4 = 0;
                  ...
                  $stmt_op_1_5=$dbcon->prepare("SELECT Enrolled_Students FROM Session_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_5->execute();
                  $json_op_1_5 = 0;
                  ...
                  $stmt_op_1_6=$dbcon->prepare("SELECT Duration_Minutes FROM Session_One_Hour WHERE ID = '$ID'");       
                  $stmt_op_1_6->execute();
                  $json_op_1_6 = 0;
                      ...
                      <tbody>
                        <?php
                          if(isset($_POST['submit1'])){
                            ...
                            $stmt_sp_1=$dbcon->prepare("SELECT Time_Slot, Student_Activity, Student_Engagement*100, Num_Students FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                            $stmt_sp_1->execute();
                      ...
                      <tbody>
                        <?php
                          if(isset($_POST['submit1'])){
                            ...
                            $stmt_lp_1=$dbcon->prepare("SELECT Time_Slot, Faculty_Activity, Student_Engagement*100 FROM Class_Activity_One_Hour WHERE ID = '$ID'");       
                            $stmt_lp_1->execute();
    ...
    <script>
      ...
      if(isset($_POST['submit1'])){
        ...
        $stmt_ip_1=$dbcon->prepare("SELECT Faculty_Activity, COUNT(Faculty_Activity)*2 FROM Class_Activity_One_Hour WHERE ID = '$ID' GROUP BY Faculty_Activity");
        $stmt_ip_1->execute();
        $json_ip_1_1 =[];
        $json_ip_1_2 = [];
        ...
        $stmt_sp_1=$dbcon->prepare("SELECT Student_Activity, COUNT(Student_Activity)*0.25132, AVG(Student_Engagement)*100 FROM Class_Activity_One_Hour WHERE ID = '$ID' GROUP BY Student_Activity");
        $stmt_sp_1->execute();
        $json_sp_1_1 =[];
        $json_sp_1_2 = [];
        $json_sp_1_3 = [];
        ...
        $stmt_ss_1=$dbcon->prepare("SELECT Time_Slot, Num_Students FROM Class_Activity_One_Hour WHERE ID = '$ID'");
        $stmt_ss_1->execute();
        $json_ss_1_1 =[];
        $json_ss_1_2 = [];
        ...
        $stmt_se_1=$dbcon->prepare("SELECT Time_Slot, (Student_Engagement)*100 FROM Class_Activity_One_Hour WHERE ID = '$ID'");
        $stmt_se_1->execute();
        $json_se_1_1 =[];
        $json_se_1_2 = [];
