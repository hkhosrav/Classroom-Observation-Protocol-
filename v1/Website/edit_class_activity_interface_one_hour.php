                  ...
                  <div class="x_content">
                    <table class="table table-hover">
                      ...
                      <?php
                          ...
                          $stmt_1=$dbcon->prepare("SELECT ID, Time_Slot, Student_Activity, Faculty_Activity, Student_Engagement, Num_Students FROM Class_Activity_One_Hour WHERE ID = '$id'");       
                          $stmt_1->execute();
                          ...
                          while($row1=$stmt_1->fetch(PDO::FETCH_ASSOC)  ){
                            ...
                            echo "<tr><form action=update_class_activity_one_hour.php method=post>";
