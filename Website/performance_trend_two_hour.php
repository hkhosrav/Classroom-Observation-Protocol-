  ...
  <body class="nav-md">
        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
                <a href="performance_trend_two_hour.php" class="site_title">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <br>
                    <form class="form-horizontal form-label-left" id="Form" action="performance_trend_two_hour.php" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          ...
                          <?php
                          $stmt_1=$dbcon->prepare("SELECT Course_Code FROM Session_Two_Hour GROUP BY Course_Code");
                          $stmt_1->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Year">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_2=$dbcon->prepare("SELECT Year FROM Session_Two_Hour GROUP BY Year");
                            $stmt_2->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Semester">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_3=$dbcon->prepare("SELECT Semester FROM Session_Two_Hour GROUP BY Semester");
                            $stmt_3->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Instructor">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_4=$dbcon->prepare("SELECT Personal_No, First_Name, Last_Name FROM Instructor WHERE Personal_No IN (SELECT Instructor FROM Session_Two_Hour GROUP BY Instructor)");
                            $stmt_4->execute();
              ...
              <?php
                if(isset($_POST['submit1'])){
                  ...
                  $stmt_op_1_6=$dbcon->prepare("SELECT COUNT(*) FROM Session_Two_Hour WHERE ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                  $stmt_op_1_6->execute();
                  $json_op_1_6 = 0;
                  ...
                  $stmt_op_1_1=$dbcon->prepare("SELECT COUNT(DISTINCT(Student_Activity)) FROM Class_Activity_Two_Hour WHERE ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                  $stmt_op_1_1->execute();
                  $json_op_1_1 = 0;
                  ...
                  $stmt_op_1_2=$dbcon->prepare("SELECT COUNT(DISTINCT(Faculty_Activity)) FROM Class_Activity_Two_Hour WHERE ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                  $stmt_op_1_2->execute();
                  $json_op_1_2 = 0;
                  ...
                  $stmt_op_1_3=$dbcon->prepare("SELECT AVG(Student_Engagement)*100 FROM Class_Activity_Two_Hour WHERE ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                  $stmt_op_1_3->execute();
                  $json_op_1_3 = 0;
                  ...
                  $stmt_op_1_4=$dbcon->prepare("SELECT AVG(Num_Students) FROM Class_Activity_Two_Hour WHERE ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                  $stmt_op_1_4->execute();
                  $json_op_1_4 = 0;
                      ...
                      <tbody>
                        <?php
                          if(isset($_POST['submit1'])){
                            ...
                            $stmt_lp_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Teaching_Week, Date, Start_Time, COUNT(DISTINCT(Faculty_Activity)), AVG(Student_Engagement*100), AVG(Num_Students) FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Teaching_Week, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(Session_Two_Hour.ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                            $stmt_lp_1->execute();
                      ...
                      <tbody>
                        <?php
                          if(isset($_POST['submit1'])){
                            ...
                            $stmt_sp_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Teaching_Week, Date, Start_Time, COUNT(DISTINCT(Student_Activity)), AVG(Student_Engagement*100), AVG(Num_Students) FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Teaching_Week, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(Session_Two_Hour.ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");       
                            $stmt_sp_1->execute();
    ...
    <script>
      ...
      if(isset($_POST['submit1'])){
        ...
        $stmt_sa_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Date, Start_Time, COUNT(DISTINCT(Student_Activity)) FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");
        $stmt_sa_1->execute();
        $json_sa_1_1 =[];
        $json_sa_1_2 = [];
        $json_sa_1_3 = [];
        ...
        $stmt_e_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Date, Start_Time, AVG(Student_Engagement)*100 FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");
        $stmt_e_1->execute();
        $json_e_1_1 =[];
        $json_e_1_2 = [];
        $json_e_1_3 = [];
        ...
        $stmt_ia_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Date, Start_Time, COUNT(DISTINCT(Faculty_Activity)) FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");
        $stmt_ia_1->execute();
        $json_ia_1_1 =[];
        $json_ia_1_2 = [];
        $json_ia_1_3 = [];
        ...
        $stmt_ss_1=$dbcon->prepare("SELECT Class_Activity_Two_Hour.ID, Date, Start_Time, AVG(Num_Students) FROM Class_Activity_Two_Hour INNER JOIN Session_Two_Hour ON Class_Activity_Two_Hour.ID = Session_Two_Hour.ID GROUP BY Class_Activity_Two_Hour.ID, Date, Start_Time HAVING Class_Activity_Two_Hour.ID IN (SELECT MIN(ID) FROM Session_Two_Hour GROUP BY Year, Semester, Teaching_Week, Date, Course_Code, Instructor, Start_Time HAVING Year = '$Year' AND Semester = '$Semester' AND Course_Code = '$Course_Code' AND Instructor = '$Personal_No')");
        $stmt_ss_1->execute();
        $json_ss_1_1 =[];
        $json_ss_1_2 = [];
        $json_ss_1_3 = [];
