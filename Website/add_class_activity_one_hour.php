        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
                <a href="add_class_activity_one_hour.php" class="site_title">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add class activities to a session <small>50 min session</small></h2>
                    ...
                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                        ...
                        <div id="myTabContent" class="tab-content">
                          <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                            ...
                            <form class="form-horizontal form-label-left" id="validateForm" action="add_class_activity_one_hour.php" method="post">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                  <select class="form-control" name="Duration_Minutes">
                                    <option value="">Choose option</option>
                                    <?php
                                    $stmt_1=$dbcon->prepare("SELECT Duration_Minutes FROM Class_Duration_One_Hour");
                                    $stmt_1->execute();
                                    while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                              ...
                              <div class="row">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 04-06</label>                                
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts2">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts2']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts2">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts2']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts2">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts2']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts2" value="<?php if(isset($_POST['ns_ts2'])){echo htmlentities($_POST['ns_ts2']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 06-08</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts3">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts3']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts3">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts3']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts3">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts3']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts3" value="<?php if(isset($_POST['ns_ts3'])){echo htmlentities($_POST['ns_ts3']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 08-10</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts4">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts4']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts4">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts4']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts4">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts4']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder  ="Number of Students" name="ns_ts4" value="<?php if(isset($_POST['ns_ts4'])){echo htmlentities($_POST['ns_ts4']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 10-12</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts5">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts5']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts5">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts5']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts5">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts5']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts5" value="<?php if(isset($_POST['ns_ts5'])){echo htmlentities($_POST['ns_ts5']);}?>">
                                  </div>

                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 12-14</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts6">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts6']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts6">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts6']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts6">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts6']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts6" value="<?php if(isset($_POST['ns_ts6'])){echo htmlentities($_POST['ns_ts6']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 14-16</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts7">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts7']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts7">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts7']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts7">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts7']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts7" value="<?php if(isset($_POST['ns_ts7'])){echo htmlentities($_POST['ns_ts7']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 16-18</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts8">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts8']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts8">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts8']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts8">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts8']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts8" value="<?php if(isset($_POST['ns_ts8'])){echo htmlentities($_POST['ns_ts8']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 18-20</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts9">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts9']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts9">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts9']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts9">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts9']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts9" value="<?php if(isset($_POST['ns_ts9'])){echo htmlentities($_POST['ns_ts9']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 20-22</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts10">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts10']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?> 
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts10">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts10']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts10">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts10']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts10" value="<?php if(isset($_POST['ns_ts10'])){echo htmlentities($_POST['ns_ts10']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 22-24</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts11">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts11']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts11">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts11']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts11">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts11']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts11" value="<?php if(isset($_POST['ns_ts11'])){echo htmlentities($_POST['ns_ts11']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 24-26</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts12">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts12']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts12">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts12']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts12">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts12']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts12" value="<?php if(isset($_POST['ns_ts12'])){echo htmlentities($_POST['ns_ts12']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 26-28</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts13">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts13']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts13">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts13']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts13">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts13']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts13" value="<?php if(isset($_POST['ns_ts13'])){echo htmlentities($_POST['ns_ts13']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 28-30</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts14">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts14']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts14">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts14']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts14">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts14']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts14" value="<?php if(isset($_POST['ns_ts14'])){echo htmlentities($_POST['ns_ts14']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 30-32</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts15">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts15']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts15">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts15']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts15">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts15']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts15" value="<?php if(isset($_POST['ns_ts15'])){echo htmlentities($_POST['ns_ts15']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 32-34</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts16">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts16']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts16">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts16']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts16">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts16']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts16" value="<?php if(isset($_POST['ns_ts16'])){echo htmlentities($_POST['ns_ts16']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 34-36</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts17">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts17']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts17">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts17']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts17">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts17']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts17" value="<?php if(isset($_POST['ns_ts17'])){echo htmlentities($_POST['ns_ts17']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 36-38</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts18">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts18']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts18">
                                      <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['la_ts18']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts18">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts18']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts18" value="<?php if(isset($_POST['ns_ts18'])){echo htmlentities($_POST['ns_ts18']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 38-40</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts19">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts19']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts19">
                                      <option value="">Lecturer/Instructor Activity</option>
                                        <?php
                                          $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                          $stmt_1->execute();
                                          while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                            echo "<option value=\"".$row['Activity']."\"";
                                            if(isset($_POST['la_ts19']) == $row['Activity'])
                                                echo 'selected';
                                            echo ">".$row['Activity']."</option>";
                                          }
                                        ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts19">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts19']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts19" value="<?php if(isset($_POST['ns_ts19'])){echo htmlentities($_POST['ns_ts19']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 40-42</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts20">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts20']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts20">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                        $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                        $stmt_1->execute();
                                        while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                          echo "<option value=\"".$row['Activity']."\"";
                                          if(isset($_POST['la_ts20']) == $row['Activity'])
                                              echo 'selected';
                                          echo ">".$row['Activity']."</option>";
                                          }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts20">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts20']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts20" value="<?php if(isset($_POST['ns_ts20'])){echo htmlentities($_POST['ns_ts20']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 42-44</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts21">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts21']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts21">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                        $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                        $stmt_1->execute();
                                        while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                          echo "<option value=\"".$row['Activity']."\"";
                                          if(isset($_POST['la_ts21']) == $row['Activity'])
                                              echo 'selected';
                                          echo ">".$row['Activity']."</option>";
                                          }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts21">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts21']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts21" value="<?php if(isset($_POST['ns_ts21'])){echo htmlentities($_POST['ns_ts21']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 44-46</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts22">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts22']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts22">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                        $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                        $stmt_1->execute();
                                        while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                          echo "<option value=\"".$row['Activity']."\"";
                                          if(isset($_POST['la_ts22']) == $row['Activity'])
                                              echo 'selected';
                                          echo ">".$row['Activity']."</option>";
                                          }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts22">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts22']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder = "Number of Students" name="ns_ts22" value="<?php if(isset($_POST['ns_ts22'])){echo htmlentities($_POST['ns_ts22']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-2 col-xs-12">Time Slot : 46-48</label>
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="sa_ts23">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts23']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts23">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                        $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                        $stmt_1->execute();
                                        while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                          echo "<option value=\"".$row['Activity']."\"";
                                          if(isset($_POST['la_ts23']) == $row['Activity'])
                                              echo 'selected';
                                          echo ">".$row['Activity']."</option>";
                                          }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts23">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts23']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts23" value="<?php if(isset($_POST['ns_ts23'])){echo htmlentities($_POST['ns_ts23']);}?>">
                                  </div>
                                </div>

                                <div class="form-group">
                                  <label class="control-label col-md-2 col-sm-12 col-xs-12">Time Slot : 48-50</label>
                                  <div class="col-md-3 col-sm- col-xs-12">
                                    <select class="form-control" name="sa_ts24">
                                      <option value="">Student Activity</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Activity FROM Student_Activities");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Activity']."\"";
                                        if(isset($_POST['sa_ts24']) == $row['Activity'])
                                            echo 'selected';
                                        echo ">".$row['Activity']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-3 col-sm-12 col-xs-12">
                                    <select class="form-control" name="la_ts24">
                                    <option value="">Lecturer/Instructor Activity</option>
                                      <?php
                                        $stmt_1=$dbcon->prepare("SELECT Activity FROM Faculty_Activities");
                                        $stmt_1->execute();
                                        while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                          echo "<option value=\"".$row['Activity']."\"";
                                          if(isset($_POST['la_ts24']) == $row['Activity'])
                                              echo 'selected';
                                          echo ">".$row['Activity']."</option>";
                                          }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <select class="form-control" name="se_ts24">
                                      <option value="">Student Engagement</option>
                                      <?php
                                      $stmt_1=$dbcon->prepare("SELECT Engagement FROM Student_Engagement");
                                      $stmt_1->execute();
                                      while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                                        echo "<option value=\"".$row['Engagement']."\"";
                                        if(isset($_POST['se_ts24']) == $row['Engagement'])
                                            echo 'selected';
                                        echo ">".$row['Engagement']."</option>";
                                      }
                                      ?>
                                  ...
                                  <div class="col-md-2 col-sm-12 col-xs-12">
                                    <input type = "text" class="form-control" placeholder="Number of Students" name="ns_ts24" value="<?php if(isset($_POST['ns_ts24'])){echo htmlentities($_POST['ns_ts24']);}?>">
                                  </div>
                                </div>
                            ...
                            <?php
                              if(isset($_POST['preview_add_data_tab1'])){                               
                                ...
                                for($i = 0; $i < 25; $i++){
                                  $stmt_class_activity_preview=$dbcon->prepare("INSERT INTO `Class_Activity_One_Hour_Preview`(`ID`, `Time_Slot`, `Faculty_Activity`, `Student_Activity`, `Student_Engagement`, `Num_Students`) VALUES('$last_id', '$slots[$i]','$la_array[$i]','$sa_array[$i]','$se_array[$i]','$ns_array[$i]');");                                     
                                  $stmt_class_activity_preview->execute();
                                }
                                  
                                echo '<span style="color:#c9302c; text-align:center;">Class Activity data added for preview. ';
                                echo '<br>';
                                header("location:https://projectdemos.uqcloud.net/COPUS/add_class_activity_one_hour.php");
                              }
                            ?>
                            ...
                            <?php
                              if(isset($_POST['submit_add_data_tab1'])){                               
                                ...
                                for($i = 0; $i < 25; $i++){
                                  $stmt_class_activity_preview=$dbcon->prepare("INSERT INTO `Class_Activity_One_Hour`(`ID`, `Time_Slot`, `Faculty_Activity`, `Student_Activity`, `Student_Engagement`, `Num_Students`) VALUES('$last_id', '$slots[$i]','$la_array[$i]','$sa_array[$i]','$se_array[$i]','$ns_array[$i]');");                                     
                                  $stmt_class_activity_preview->execute();
                                }
                          ...
                          <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                                ...
                                <div class="x_panel">
                                  ...
                                  <div class="x_content">
                                    <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php
                                            $stmt_sa_1=$dbcon->prepare("SELECT Time_Slot, Student_Activity, Student_Engagement*100, Num_Students FROM Class_Activity_One_Hour_Preview");       
                                            $stmt_sa_1->execute();
                                ...
                                <div class="x_panel">
                                  ...
                                  <div class="x_content">
                                    <table id="datatable-responsive2" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        <?php
                                            $stmt_lp_1=$dbcon->prepare("SELECT Time_Slot, Faculty_Activity, Student_Engagement*100 FROM Class_Activity_One_Hour_Preview");       
                                            $stmt_lp_1->execute();
                            ...
                            <div class="row">
                              <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                  <div class="x_content">                    
                                    <form class="form-horizontal form-label-left" action="add_class_activity_one_hour.php" method="post">
                                      <div class="form-group">
                            ...
                            <?php
                              if(isset($_POST['discard_add_data_tab2'])){
                                ...
                                $stmt_op_1=$dbcon->prepare("DELETE FROM `Class_Activity_One_Hour_Preview`;");       
                                $stmt_op_1->execute();
