          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Choose a session to edit <small>110 min session</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" id="validateForm" action="edit_class_activity_interface_two_hour.php" method="post">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Semester">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_1=$dbcon->prepare("SELECT Semester FROM Session_Two_Hour GROUP BY Semester");
                            $stmt_1->execute();
                            while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Teaching_Week">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_1=$dbcon->prepare("SELECT Teaching_Week FROM Session_Two_Hour GROUP BY Teaching_Week");
                            $stmt_1->execute();
                            while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Date">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_1=$dbcon->prepare("SELECT Date FROM Session_Two_Hour GROUP BY Date");
                            $stmt_1->execute();
                            while ($row=$stmt_1->fetch(PDO::FETCH_ASSOC)){
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Instructor">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_1=$dbcon->prepare("SELECT Personal_No, First_Name, Last_Name FROM Instructor WHERE Personal_No IN (SELECT Instructor FROM Session_Two_Hour GROUP BY Instructor)");
                            $stmt_1->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="Start_Time">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_3=$dbcon->prepare("SELECT Start_Time FROM Session_Two_Hour GROUP BY Start_Time");
                            $stmt_3->execute();
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <select class="form-control" name="ID">
                            <option value="">Choose option</option>
                            <?php
                            $stmt_3=$dbcon->prepare("SELECT ID FROM Session_Two_Hour GROUP BY ID");
                            $stmt_3->execute();
                            while ($row=$stmt_3->fetch(PDO::FETCH_ASSOC)){
